...
from claude_analyzer import analyze_with_claude, format_segments_for_prompt
...
def main():
    ...
    if args.provider == "claude":
        result = analyze_with_claude(segments, keep_alternatives=args.keep_alternatives)
    else:
        result = analyze_with_codex(segments, keep_alternatives=args.keep_alternatives)
